...
// 触发事件，让监听函数执行
asyncParallelBailHook.callAsync("panda", 18,function(params){
    console.log(params)
});
// 1 panda 18
// 2 panda 18
...
// 触发事件，让监听函数执行
asyncParallelBailHook.promise("panda", 18).then(function(params){
    console.log(params)
});
...
// 触发事件，让监听函数执行
asyncSeriesBailHook.callAsync("panda", 18,function(params){
    console.log(params)
})
// 1 panda 18
// 2 panda 18
...
// 触发事件，让监听函数执行
asyncSeriesBailHook.promise("panda", 18).then(function(params){
    console.log(params)
});
// 1 panda 18
// true
...
// 触发事件，让监听函数执行
asyncSeriesWaterfallHook.promise("panda", 18).then(function(params){
    console.log(params)
})
// 1 panda 18
// 2 panda---1 18
